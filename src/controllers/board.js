...
export default class BoardController {
  ...
  createTask() {
    ...
    console.log(`Board EmptyTask`, EmptyTask)
    this._creatingTask.render(EmptyTask, TaskControllerMode.ADDING);
    // console.log(`Board this._tasksModel`, this._tasksModel);
  }
...
//
//     if (isAllTasksArchived) {
//       render(container, this._noTasksComponent.getElement(), RENDER_POSITION.BEFOREEND);
//       return;
//     }
//
//     render(container, this._sortComponent.getElement(), RENDER_POSITION.BEFOREEND);
